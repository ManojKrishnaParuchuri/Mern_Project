...
<div className=" relative w-fit  top-0   bg-black py-9">
 ...
 <NavLink className='text-orange-400 pt-1 text-2xl  text-ellipsis   -mx-80 font-serif hover:text-slate-600'  to={"/"}>Logout</NavLink>
 </div> 
  </ul>
</div>
{/* <div className=" relative h-screen mx-36"> */}
<img className=" relative h-screen mx-36 " src="https://images.static-collegedunia.com/public/college_data/images/pdfthumb/1503896330klu-prospectus-2017/full-0.jpg" alt='klu' />{/* </div> */}
</div>
</>
